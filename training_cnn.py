...
############  Train Dataset   ############
train_dir = os.path.join(r"/Users/anushraypingale/Downloads/dataaset soil/training_set") #Train directory

############  Test Dataset   ############
test_dir = os.path.join(r"/Users/anushraypingale/Downloads/dataaset soil/test_set") # Test Directory
